...
const Navbar = () => {
  ...
  return (
    <div className="absolute top-0 left-0 w-full z-10">
      ...
      {/* --------- mobile-menu --------- */}
      <div className={`md:hidden ${showMobileMenu ? 'fixed w-full' : 'h-0 w-0'} right-0  top-0 bottom-0 overflow-hidden bg-white transitiona-all`}>
        <div className="flex justify-end p-6 cursor-pointer">
          <img onClick={()=> setShowMobileMenu(false)} src={assets.cross_icon} className="w-6 hover:bg-red-500" alt="" />
        </div>
